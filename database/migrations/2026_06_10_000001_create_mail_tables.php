...
return static function (PDO $pdo): void {
    ...
    try {
        ...
        $required = [
            ...
            'imap_enabled' => 'ALTER TABLE mail_settings ADD COLUMN imap_enabled TINYINT(1) NOT NULL DEFAULT 1 AFTER smtp_password',
            'imap_host' => 'ALTER TABLE mail_settings ADD COLUMN imap_host VARCHAR(190) NULL AFTER imap_enabled',
            'imap_port' => 'ALTER TABLE mail_settings ADD COLUMN imap_port INT NULL AFTER imap_host',
            'imap_user' => 'ALTER TABLE mail_settings ADD COLUMN imap_user VARCHAR(190) NULL AFTER imap_port',
            'imap_password' => 'ALTER TABLE mail_settings ADD COLUMN imap_password VARCHAR(255) NULL AFTER imap_user',
            'imap_encryption' => "ALTER TABLE mail_settings ADD COLUMN imap_encryption VARCHAR(20) NULL DEFAULT 'ssl' AFTER imap_password",
            'company_name' => 'ALTER TABLE mail_settings ADD COLUMN company_name VARCHAR(190) NULL AFTER imap_encryption',
