 ...
 * Public API_BACKEND_MAIN_BASE_URL stays on the admin host /api/v2 for diagnostics.
 */
...
if (!defined('API_BACKEND_INTERNAL_HOST')) {
    ...
    if ($internalHost === '') {
        $internalHost = strtolower((string) (parse_url(
            ...
            PHP_URL_HOST
        ) ?: (parse_url(deploy_domain('backend_url'), PHP_URL_HOST) ?: 'admin.vegasroyalspin.com')));
    }
