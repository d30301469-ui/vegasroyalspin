...
if ($__sharedRoot === null) {
    throw new RuntimeException('shared/ not found for api/MemberBalance.php (deploy shared/ next to admin or at monorepo root).');
}
require_once $__sharedRoot . '/runtime.php';
require_once $__sharedRoot . '/api/MemberBalance.php';
