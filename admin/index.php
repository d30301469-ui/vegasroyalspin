...
$router->get('/affiliates', [AdminAffiliateController::class, 'index']);
$router->get('/affiliate/detail', [AdminAffiliateController::class, 'detail']);
$router->post('/affiliate/update', [AdminAffiliateController::class, 'update']);
...
$router->post('/affiliate/material-delete', [AdminAffiliateController::class, 'deleteMaterial']);
