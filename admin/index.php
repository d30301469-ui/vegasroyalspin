...
$router->get('/casino-aggregator/game-control', [AdminCasinoAggregatorController::class, 'gameControl']);
...
$router->get('/gsc-plus/settings', [AdminGamingSoftController::class, 'settings']);
$router->post('/gsc-plus/settings', [AdminGamingSoftController::class, 'updateSettings']);
$router->post('/gsc-plus/sync-products', [AdminGamingSoftController::class, 'syncProducts']);
$router->post('/gsc-plus/sync-games', [AdminGamingSoftController::class, 'syncGames']);
