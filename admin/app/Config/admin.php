...
return [
    ...
    'modules' => [
        ...
        'gamingsoft-sessions' => [
            ...
            'table' => 'gamingsoft_sessions',
            'active' => 'datatable',
            'crumbs' => 'Gaming Soft | Sessions',
            'columns' => ['id', 'user_id', 'username', 'member_account', 'product_code', 'game_code', 'currency', 'platform', 'created_at'],
            'search_placeholder' => 'Kullanıcı veya oyun ara...',
        ],
        'gamingsoft-transactions' => [
            'title' => 'GSC+ İşlemleri',
            'table' => 'gamingsoft_transactions',
            'active' => 'datatable',
            'crumbs' => 'Gaming Soft | Transactions',
            'columns' => ['id', 'user_id', 'username', 'txn_id', 'wager_code', 'round_id', 'product_code', 'game_code', 'action', 'amount', 'before_balance', 'after_balance', 'currency', 'endpoint', 'created_at'],
            'search_placeholder' => 'Kullanıcı, txn veya wager ara...',
        ],
        'gamingsoft-wallet-logs' => [
            'title' => 'GSC+ Wallet Logları',
            'table' => 'gamingsoft_wallet_logs',
            'active' => 'datatable',
    ...
    'navigation' => [
        ...
        [
            'label' => 'Gaming Soft (GSC+)',
            'caption' => 'Seamless wallet & multi-product games',
            'items' => [
