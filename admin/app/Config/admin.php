...
return [
    ...
    'modules' => [
        ...
        'gsc-plus-games' => [
            ...
            'active' => 'datatable',
            'crumbs' => 'GSC+ | Games',
            'columns' => ['id', 'product_code', 'game_code', 'game_name', 'game_type', 'provider', 'support_currency', 'status', 'entry_type', 'is_active', 'is_featured', 'synced_at'],
        ...
        'gsc-plus-settings' => [
            ...
            'active' => 'forms',
            'crumbs' => 'GSC+ | Settings',
            'columns' => ['id', 'operator_code', 'currency', 'language_code', 'is_active', 'operator_url', 'updated_at'],
            'search_placeholder' => 'GSC+ ayarı ara...',
        ],
        'promotions' => [
            'title' => 'Promosyonlar',
            'table' => 'promotions',
