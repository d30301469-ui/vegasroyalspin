...
return [
    ...
    'modules' => [
        ...
        'drakon-games' => [
            ...
            'columns' => ['id', 'game_id', 'game_name', 'provider_name', 'rtp', 'is_active', 'synced_at'],
            'search_placeholder' => 'Drakon oyun adı veya provider ara...',
        ],
        'drakon-providers' => [
            'title' => 'Drakon Sağlayıcılar',
        ...
        'drakon-transactions' => [
            ...
            'columns' => ['id', 'user_id', 'username', 'transaction_id', 'round_id', 'game_name', 'txn_type', 'amount', 'before_balance', 'after_balance', 'created_at'],
            'search_placeholder' => 'Kullanıcı, işlem veya oyun ara...',
        ],
        'drakon-webhook-logs' => [
    ...
    'navigation' => [
        ...
        [
            ...
            'items' => [
                ...
                ['key' => 'drakon-webhook-logs', 'text' => 'Drakon Webhook Logları', 'url' => '/module?key=drakon-webhook-logs', 'active' => 'datatable', 'module' => 'drakon-webhook-logs', 'icon' => '<path d="M4 4h16v16H4z"/><path d="M8 9h8M8 13h8M8 17h5"/>'],
            ],
        ],
        [
        ...
        [
            ...
            'items' => [
                ['key' => 'footer-settings', 'text' => 'Footer Section', 'url' => '/module?key=footer-settings', 'active' => 'datatable', 'module' => 'footer-settings', 'icon' => '<path d="M4 5h16v10H4z"/><path d="M4 19h16"/><path d="M8 15v4M16 15v4"/>'],
