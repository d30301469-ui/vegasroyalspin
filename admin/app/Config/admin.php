...
return [
    ...
    'navigation' => [
        ...
        [
            'label' => 'GSC+',
            'caption' => 'GamingSoft seamless wallet (Operator API v2.0.6)',
            'items' => [
                ['key' => 'gsc-plus-settings', 'text' => 'GSC+ Ayarları', 'url' => '/gsc-plus/settings', 'active' => 'datatable', 'module' => 'gsc-plus-settings', 'icon' => '<circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/>'],
                ['key' => 'gsc-plus-products', 'text' => 'Ürünler', 'url' => '/module?key=gsc-plus-products', 'active' => 'datatable', 'module' => 'gsc-plus-products', 'icon' => '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/>'],
                ['key' => 'gsc-plus-games', 'text' => 'Oyunlar', 'url' => '/module?key=gsc-plus-games', 'active' => 'datatable', 'module' => 'gsc-plus-games', 'icon' => '<rect x="2" y="5" width="20" height="13" rx="2"/><path d="M8 22h8M12 18v4"/>'],
                ['key' => 'gsc-plus-sessions', 'text' => 'Oturumlar', 'url' => '/module?key=gsc-plus-sessions', 'active' => 'datatable', 'module' => 'gsc-plus-sessions', 'icon' => '<path d="M3 3v18h18"/><path d="M7 15h3v3H7z"/>'],
                ['key' => 'gsc-plus-transactions', 'text' => 'İşlemler', 'url' => '/module?key=gsc-plus-transactions', 'active' => 'datatable', 'module' => 'gsc-plus-transactions', 'icon' => '<path d="M3 3v18h18"/><path d="m7 14 3-3 3 2 4-6"/>'],
                ['key' => 'gsc-plus-wagers', 'text' => 'Wagers', 'url' => '/module?key=gsc-plus-wagers', 'active' => 'datatable', 'module' => 'gsc-plus-wagers', 'icon' => '<path d="M4 4h16v16H4z"/><path d="M8 9h8M8 13h8"/>'],
                ['key' => 'gsc-plus-wallet-logs', 'text' => 'Wallet Logları', 'url' => '/module?key=gsc-plus-wallet-logs', 'active' => 'datatable', 'module' => 'gsc-plus-wallet-logs', 'icon' => '<path d="M4 4h16v16H4z"/>'],
            ],
        ],
        [
