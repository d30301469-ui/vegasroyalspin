...
return [
    ...
    'modules' => [
        ...
        'sportsbook-sessions' => [
            'title' => 'Sportsbook Oturumları',
            'table' => 'sportsbook_sessions',
            'active' => 'datatable',
            'crumbs' => 'Sportsbook | Sessions',
            'columns' => ['id', 'user_id', 'username', 'user_code', 'currency', 'lang', 'channel', 'created_at'],
            'search_placeholder' => 'Kullanıcı veya oturum ara...',
        ],
        'sportsbook-transactions' => [
            'title' => 'Sportsbook İşlemleri',
            'table' => 'sportsbook_transactions',
            'active' => 'datatable',
            'crumbs' => 'Sportsbook | Transactions',
            'columns' => ['id', 'user_id', 'username', 'txn_code', 'wager_id', 'round_id', 'txn_type', 'amount', 'before_balance', 'after_balance', 'currency', 'created_at'],
            'search_placeholder' => 'Kullanıcı, işlem kodu veya wager ara...',
        ],
        'sportsbook-wallet-logs' => [
            'title' => 'Sportsbook Wallet Logları',
            'table' => 'sportsbook_wallet_logs',
            'active' => 'datatable',
            'crumbs' => 'Sportsbook | Wallet Logs',
            'columns' => ['id', 'method', 'user_id', 'txn_code', 'http_status', 'status_code', 'error_code', 'duration_ms', 'created_at'],
            'search_placeholder' => 'Method, kullanıcı veya hata ara...',
        ],
        'casino-aggregator-vendors' => [
            'title' => 'Aggregator Vendorlar',
            'table' => 'casino_aggregator_vendors',
            'active' => 'datatable',
            'crumbs' => 'Casino Aggregator | Vendors',
            'columns' => ['id', 'vendor_code', 'vendor_name', 'game_type', 'is_active', 'synced_at'],
            'search_placeholder' => 'Vendor kodu veya adı ara...',
        ],
        'casino-aggregator-games' => [
            'title' => 'Aggregator Oyunları',
            'table' => 'casino_aggregator_games',
            'active' => 'datatable',
            'crumbs' => 'Casino Aggregator | Games',
            'columns' => ['id', 'image_url', 'vendor_code', 'game_code', 'game_name', 'game_type', 'is_active', 'is_featured', 'synced_at'],
            'search_placeholder' => 'Oyun adı, vendor veya game code ara...',
        ],
        'casino-aggregator-sessions' => [
            'title' => 'Aggregator Oturumları',
            'table' => 'casino_aggregator_sessions',
            'active' => 'datatable',
            'crumbs' => 'Casino Aggregator | Sessions',
            'columns' => ['id', 'user_id', 'username', 'user_code', 'vendor_code', 'game_code', 'currency', 'channel', 'created_at'],
            'search_placeholder' => 'Kullanıcı veya oyun ara...',
        ],
        'casino-aggregator-transactions' => [
            'title' => 'Aggregator İşlemleri',
            'table' => 'casino_aggregator_transactions',
            'active' => 'datatable',
            'crumbs' => 'Casino Aggregator | Transactions',
            'columns' => ['id', 'user_id', 'username', 'txn_code', 'wager_id', 'round_id', 'vendor_code', 'game_code', 'txn_type', 'amount', 'before_balance', 'after_balance', 'currency', 'created_at'],
            'search_placeholder' => 'Kullanıcı, işlem kodu veya wager ara...',
        ],
        'casino-aggregator-wallet-logs' => [
            'title' => 'Aggregator Wallet Logları',
            'table' => 'casino_aggregator_wallet_logs',
            'active' => 'datatable',
            'crumbs' => 'Casino Aggregator | Wallet Logs',
            'columns' => ['id', 'method', 'user_id', 'txn_code', 'http_status', 'status_code', 'error_code', 'duration_ms', 'created_at'],
            'search_placeholder' => 'Method, kullanıcı veya hata ara...',
        ],
        'gamingsoft-products' => [
            ...
            'search_placeholder' => 'Provider veya product code ara...',
        ],
        'gamingsoft-games' => [
            'title' => 'GSC+ Oyunları',
            'table' => 'gsc_games',
            ...
            'columns' => ['id', 'product_code', 'game_code', 'game_name', 'game_type', 'provider', 'support_currency', 'status', 'is_active', 'is_featured', 'synced_at'],
        ...
        'gamingsoft-transactions' => [
            ...
            'active' => 'datatable',
            'crumbs' => 'Gaming Soft | Transactions',
            'columns' => ['id', 'user_id', 'member_account', 'transaction_id', 'action', 'wager_code', 'round_id', 'product_code', 'game_code', 'amount', 'before_balance', 'after_balance', 'currency', 'direction', 'created_at'],
            'search_placeholder' => 'Üye, transaction veya wager ara...',
        ],
        'gamingsoft-wagers' => [
            'title' => 'GSC+ Wagers',
            'table' => 'gsc_wagers',
            'active' => 'datatable',
            'crumbs' => 'Gaming Soft | Wagers',
            'columns' => ['id', 'member_account', 'wager_code', 'wager_status', 'product_code', 'game_code', 'bet_amount', 'prize_amount', 'currency', 'settled_at', 'updated_at'],
            'search_placeholder' => 'Wager code veya üye ara...',
        ],
        'gamingsoft-wallet-logs' => [
            'title' => 'GSC+ Wallet Logları',
            'table' => 'gsc_wallet_logs',
            'active' => 'datatable',
            'crumbs' => 'Gaming Soft | Wallet Logs',
            'columns' => ['id', 'method', 'user_id', 'member_account', 'transaction_id', 'http_status', 'status_code', 'error_code', 'duration_ms', 'created_at'],
            'search_placeholder' => 'Method veya üye ara...',
        ],
        'promotions' => [
            'title' => 'Promosyonlar',
            'table' => 'promotions',
        ...
        'promocode-requests' => [
            'title' => 'Promocode Talepleri',
            'table' => 'promocode_requests',
            'active' => 'datatable',
            'crumbs' => 'Content | Promocode Requests',
            'columns' => ['id', 'user_id', 'promocode_code', 'amount', 'status', 'created_at', 'updated_at'],
            'search_placeholder' => 'Talep, kullanıcı veya promo kodu ara...',
        ],
        'announcements' => [
            'title' => 'Duyurular',
            'table' => 'announcements',
    ...
    'navigation' => [
        ...
        [
            ...
            'items' => [
                ...
                ['key' => 'bgaming-campaign-create', 'text' => 'Kampanya Oluştur', 'url' => '/bgaming/campaigns', 'active' => 'datatable', 'module' => 'bgaming-settings', 'permission' => 'bgaming-settings', 'icon' => '<path d="M20 12v10H4V12"/><path d="M2 7h20v5H2z"/><path d="M12 22V7"/>'],
                ['key' => 'bgaming-campaign-add', 'text' => 'Kampanya Ekle', 'url' => '/bgaming/campaigns/assignments', 'active' => 'datatable', 'module' => 'bgaming-settings', 'permission' => 'bgaming-settings', 'icon' => '<path d="M12 5v14M5 12h14"/><rect x="3" y="3" width="18" height="18" rx="2"/>'],
                ['key' => 'bgaming-freespins', 'text' => 'Freespin Yönetimi', 'url' => '/bgaming/freespins', 'active' => 'datatable', 'module' => 'bgaming-settings', 'permission' => 'bgaming-settings', 'icon' => '<circle cx="12" cy="12" r="9"/><path d="M12 7v10M7 12h10"/>'],
        ...
        [
            'label' => 'Casino Aggregator',
            'caption' => 'Multi-vendor slot & live casino (Operator API)',
            'items' => [
                ['key' => 'casino-aggregator-settings', 'text' => 'Aggregator Ayarları', 'url' => '/casino-aggregator/settings', 'active' => 'datatable', 'module' => 'casino-aggregator-settings', 'icon' => '<circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/>'],
                ['key' => 'casino-aggregator-game-control', 'text' => 'Game Control', 'url' => '/casino-aggregator/game-control', 'active' => 'datatable', 'module' => 'casino-aggregator-settings', 'permission' => 'casino-aggregator-settings', 'icon' => '<path d="M8 5v14l11-7z"/>'],
                ['key' => 'casino-aggregator-agent-settings', 'text' => 'Agent Kontrolleri', 'url' => '/casino-aggregator/agent-settings', 'active' => 'datatable', 'module' => 'casino-aggregator-settings', 'permission' => 'casino-aggregator-settings', 'icon' => '<path d="M12 2v4M12 18v4M4.9 4.9l2.8 2.8M16.3 16.3l2.8 2.8M2 12h4M18 12h4M4.9 19.1l2.8-2.8M16.3 7.7l2.8-2.8"/><circle cx="12" cy="12" r="3"/>'],
                ['key' => 'casino-aggregator-user-settings', 'text' => 'Kullanıcı RTP', 'url' => '/casino-aggregator/user-settings', 'active' => 'datatable', 'module' => 'casino-aggregator-settings', 'permission' => 'casino-aggregator-settings', 'icon' => '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 11h-6M19 8v6"/>'],
                ['key' => 'casino-aggregator-vendors', 'text' => 'Vendorlar', 'url' => '/module?key=casino-aggregator-vendors', 'active' => 'datatable', 'module' => 'casino-aggregator-vendors', 'icon' => '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/>'],
                ['key' => 'casino-aggregator-games', 'text' => 'Oyunlar', 'url' => '/module?key=casino-aggregator-games', 'active' => 'datatable', 'module' => 'casino-aggregator-games', 'icon' => '<rect x="2" y="5" width="20" height="13" rx="2"/><path d="M8 22h8M12 18v4"/>'],
                ['key' => 'casino-aggregator-sessions', 'text' => 'Oturumlar', 'url' => '/module?key=casino-aggregator-sessions', 'active' => 'datatable', 'module' => 'casino-aggregator-sessions', 'icon' => '<path d="M3 3v18h18"/><path d="M7 15h3v3H7z"/>'],
                ['key' => 'casino-aggregator-transactions', 'text' => 'İşlemler', 'url' => '/module?key=casino-aggregator-transactions', 'active' => 'datatable', 'module' => 'casino-aggregator-transactions', 'icon' => '<path d="M3 3v18h18"/><path d="m7 14 3-3 3 2 4-6"/>'],
                ['key' => 'casino-aggregator-wallet-logs', 'text' => 'Wallet Logları', 'url' => '/module?key=casino-aggregator-wallet-logs', 'active' => 'datatable', 'module' => 'casino-aggregator-wallet-logs', 'icon' => '<path d="M4 4h16v16H4z"/>'],
            ],
        ],
        [
            'label' => 'Gaming Soft',
            'caption' => 'GSC+ seamless wallet (Operator API v2.0.6)',
            'items' => [
                ['key' => 'gamingsoft-settings', 'text' => 'GSC+ Ayarları', 'url' => '/gamingsoft/settings', 'active' => 'datatable', 'module' => 'gamingsoft-settings', 'icon' => '<circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/>'],
                ['key' => 'gamingsoft-products', 'text' => 'Ürünler', 'url' => '/module?key=gamingsoft-products', 'active' => 'datatable', 'module' => 'gamingsoft-products', 'icon' => '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/>'],
                ['key' => 'gamingsoft-games', 'text' => 'Oyunlar', 'url' => '/module?key=gamingsoft-games', 'active' => 'datatable', 'module' => 'gamingsoft-games', 'icon' => '<rect x="2" y="5" width="20" height="13" rx="2"/><path d="M8 22h8M12 18v4"/>'],
                ['key' => 'gamingsoft-sessions', 'text' => 'Oturumlar', 'url' => '/module?key=gamingsoft-sessions', 'active' => 'datatable', 'module' => 'gamingsoft-sessions', 'icon' => '<path d="M3 3v18h18"/><path d="M7 15h3v3H7z"/>'],
                ['key' => 'gamingsoft-transactions', 'text' => 'İşlemler', 'url' => '/module?key=gamingsoft-transactions', 'active' => 'datatable', 'module' => 'gamingsoft-transactions', 'icon' => '<path d="M3 3v18h18"/><path d="m7 14 3-3 3 2 4-6"/>'],
                ['key' => 'gamingsoft-wagers', 'text' => 'Wagers', 'url' => '/module?key=gamingsoft-wagers', 'active' => 'datatable', 'module' => 'gamingsoft-wagers', 'icon' => '<path d="M4 4h16v16H4z"/><path d="M8 9h8M8 13h8"/>'],
                ['key' => 'gamingsoft-wallet-logs', 'text' => 'Wallet Logları', 'url' => '/module?key=gamingsoft-wallet-logs', 'active' => 'datatable', 'module' => 'gamingsoft-wallet-logs', 'icon' => '<path d="M4 4h16v16H4z"/>'],
            ],
        ],
        [
            'label' => 'Spor Bahisleri',
            'caption' => 'Sportsbook (BetBy)',
            'items' => [
                ['key' => 'sportsbook-settings', 'text' => 'Sportsbook Ayarları', 'url' => '/sportsbook/settings', 'active' => 'datatable', 'module' => 'sportsbook-settings', 'icon' => '<circle cx="12" cy="12" r="10"/><path d="M12 2a15 15 0 0 1 0 20M12 2a15 15 0 0 0 0 20M2 12h20"/>'],
                ['key' => 'sportsbook-sessions', 'text' => 'Sportsbook Oturumları', 'url' => '/module?key=sportsbook-sessions', 'active' => 'datatable', 'module' => 'sportsbook-sessions', 'icon' => '<rect x="2" y="5" width="20" height="13" rx="2"/><path d="M8 22h8M12 18v4"/>'],
                ['key' => 'sportsbook-transactions', 'text' => 'Sportsbook İşlemleri', 'url' => '/module?key=sportsbook-transactions', 'active' => 'datatable', 'module' => 'sportsbook-transactions', 'icon' => '<path d="M3 3v18h18"/><path d="m7 14 3-3 3 2 4-6"/>'],
                ['key' => 'sportsbook-wallet-logs', 'text' => 'Sportsbook Wallet Logları', 'url' => '/module?key=sportsbook-wallet-logs', 'active' => 'datatable', 'module' => 'sportsbook-wallet-logs', 'icon' => '<path d="M4 4h16v16H4z"/><path d="M8 9h8M8 13h8M8 17h5"/>'],
            ],
        ],
        [
            ...
            'items' => [
                ...
                ['key' => 'email', 'text' => 'E-posta', 'url' => '/email/inbox', 'active' => 'email', 'permission' => 'email', 'icon' => '<rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 7 9 6 9-6"/>'],
        ...
        [
            ...
            'items' => [
                ['key' => 'footer-settings', 'text' => 'Footer Section', 'url' => '/module?key=footer-settings', 'active' => 'forms', 'module' => 'footer-settings', 'icon' => '<path d="M4 5h16v10H4z"/><path d="M4 19h16"/><path d="M8 15v4M16 15v4"/>'],
