...
return [
    ...
    'modules' => [
        ...
        'drakon-providers' => [
            'title' => 'Drakon Sağlayıcıları',
            'table' => 'drakon_providers',
            'active' => 'datatable',
            'crumbs' => 'Drakon Casino | Providers',
            'columns' => ['id', 'provider_code', 'provider_name', 'rtp', 'is_active', 'synced_at'],
            'search_placeholder' => 'Sağlayıcı kodu veya adı ara...',
        ],
        'drakon-games' => [
            'title' => 'Drakon Oyunları',
            'table' => 'drakon_games',
            'active' => 'datatable',
            'crumbs' => 'Drakon Casino | Games',
            'columns' => ['id', 'game_id', 'game_code', 'game_name', 'provider_name', 'rtp', 'type', 'is_active', 'is_featured', 'synced_at'],
            'search_placeholder' => 'Oyun adı, sağlayıcı veya kod ara...',
        ],
        'drakon-sessions' => [
            'title' => 'Drakon Oturumları',
            'table' => 'drakon_sessions',
            'active' => 'datatable',
            'crumbs' => 'Drakon Casino | Sessions',
            'columns' => ['id', 'user_id', 'username', 'game_id', 'game_code', 'currency', 'lang', 'mode', 'created_at'],
            'search_placeholder' => 'Kullanıcı veya oyun ara...',
        ],
        'drakon-transactions' => [
            ...
            'active' => 'datatable',
            'crumbs' => 'Drakon Casino | Transactions',
            'columns' => ['id', 'user_id', 'username', 'transaction_id', 'round_id', 'game_id', 'game_name', 'txn_type', 'amount', 'status', 'created_at'],
            'search_placeholder' => 'Kullanıcı, işlem veya round ara...',
        ],
        'drakon-webhook-logs' => [
            'title' => 'Drakon Webhook Logları',
            'table' => 'drakon_webhook_logs',
            'active' => 'datatable',
            'crumbs' => 'Drakon Casino | Webhook Logs',
            'columns' => ['id', 'method', 'user_id', 'transaction_id', 'http_status', 'error_code', 'client_ip', 'duration_ms', 'created_at'],
            'search_placeholder' => 'Method, işlem veya hata ara...',
        ],
        'drakon-settings' => [
            'title' => 'Drakon Ayarları',
            'table' => 'drakon_config',
            'active' => 'forms',
            'crumbs' => 'Drakon Casino | Settings',
            'columns' => ['id', 'agent_code', 'currency', 'lang', 'is_active', 'api_base_url', 'site_endpoint', 'updated_at'],
            'search_placeholder' => 'Drakon ayarı ara...',
        ],
        'promotions' => [
            'title' => 'Promosyonlar',
            'table' => 'promotions',
    ...
    'navigation' => [
        ...
        [
            'label' => 'Drakon Casino',
            'caption' => 'Drakon casino sağlayıcı ve operasyon yönetimi',
            'items' => [
                ['key' => 'drakon-settings', 'text' => 'Drakon Ayarları', 'url' => '/drakon/settings', 'active' => 'datatable', 'module' => 'drakon-settings', 'icon' => '<circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/>'],
                ['key' => 'drakon-campaigns', 'text' => 'Kampanyalar', 'url' => '/drakon/campaigns', 'active' => 'datatable', 'permission' => 'drakon-settings', 'icon' => '<path d="M20 12v10H4V12"/><path d="M2 7h20v5H2z"/><path d="M12 22V7"/>'],
                ['key' => 'drakon-providers', 'text' => 'Sağlayıcılar', 'url' => '/module?key=drakon-providers', 'active' => 'datatable', 'module' => 'drakon-providers', 'icon' => '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/>'],
                ['key' => 'drakon-games', 'text' => 'Oyunlar', 'url' => '/module?key=drakon-games', 'active' => 'datatable', 'module' => 'drakon-games', 'icon' => '<rect x="2" y="5" width="20" height="13" rx="2"/><path d="M8 22h8M12 18v4"/>'],
                ['key' => 'drakon-transactions', 'text' => 'İşlemler', 'url' => '/module?key=drakon-transactions', 'active' => 'datatable', 'module' => 'drakon-transactions', 'icon' => '<path d="M3 3v18h18"/><path d="m7 14 3-3 3 2 4-6"/>'],
                ['key' => 'drakon-webhook-logs', 'text' => 'Webhook Logları', 'url' => '/module?key=drakon-webhook-logs', 'active' => 'datatable', 'module' => 'drakon-webhook-logs', 'icon' => '<path d="M4 4h16v16H4z"/><path d="M8 9h8M8 13h8M8 17h5"/>'],
            ],
        ],
        [
