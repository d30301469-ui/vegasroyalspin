...
<div class="bgaming-grid">
    ...
    <aside class="bgaming-card">
        ...
        <div class="bgaming-actions admin-action-spaced">
            ...
            <a class="btn btn--secondary admin-full-action" href="<?= $text(AdminAuth::url('/bgaming/campaigns')) ?>">Freespin Oluştur</a>
            <a class="btn btn--secondary admin-full-action" href="<?= $text(AdminAuth::url('/bgaming/freespins')) ?>">Freespin Listesi</a>
