...
<section class="hero">
    <div class="hero-text">
        ...
        <p class="hero-sub">Şüpheli davranış ve operasyonel risk sinyallerini yönetin.</p>
    </div>
    <div class="hero-actions">
        <a class="btn btn--ghost" href="<?= $text(AdminAuth::url('/compliance/risk-alerts?status=open')) ?>">Açık</a>
        <a class="btn btn--ghost" href="<?= $text(AdminAuth::url('/compliance/risk-alerts?status=resolved')) ?>">Çözülmüş</a>
        <a class="btn btn--ghost" href="<?= $text(AdminAuth::url('/compliance/risk-alerts?status=')) ?>">Tümü</a>
    </div>
</section>
