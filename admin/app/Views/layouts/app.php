...
<head>
    ...
    <script defer src="<?= htmlspecialchars(AdminAuth::url('/chartjs-bridge.js'), ENT_QUOTES, 'UTF-8') ?>"></script>
        ...
        <div class="sidebar-footer">
            <div class="dd-wrap">
                ...
                <div class="dd-menu dd-profile" role="menu">
                    ...
                    <?php if ($canEmail): ?><a class="dd-menu-item" href="<?= htmlspecialchars(AdminAuth::url('/email/inbox'), ENT_QUOTES, 'UTF-8') ?>"><svg viewBox="0 0 24 24"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 7 9 6 9-6"/></svg>E-posta</a><?php endif; ?>
