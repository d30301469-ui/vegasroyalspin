...
<section class="mail-shell" aria-label="Email">
    <aside class="mail-rail">
        ...
        <div class="mail-rail-section">
            ...
            <a class="mail-folder" href="<?= htmlspecialchars(AdminAuth::url('/email/settings#reset-theme'), ENT_QUOTES, 'UTF-8') ?>"><svg viewBox="0 0 24 24"><path d="M12 3a9 9 0 1 0 9 9"/><path d="M12 7v5l3 3"/><path d="M4 4h6v6"/></svg> <span class="mail-folder-name">Sifre Sifirlama Temasi</span></a>
        </div>
