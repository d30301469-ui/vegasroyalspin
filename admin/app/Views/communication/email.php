...
<section class="mail-shell" aria-label="Email">
    <aside class="mail-rail">
        ...
        <div class="mail-rail-section">
            ...
            <a class="mail-folder" href="<?= htmlspecialchars(AdminAuth::url('/table?name=mail_settings'), ENT_QUOTES, 'UTF-8') ?>"><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/></svg> <span class="mail-folder-name">Ayarlar</span></a>
        </div>
