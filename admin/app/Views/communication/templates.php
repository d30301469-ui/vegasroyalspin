...
<section class="hero">
    <div class="hero-text">
        ...
        <p class="hero-sub">Şifre sıfırlama mail metni ve HTML şablonu.</p>
    </div>
</section>
...
<section class="card">
    <div class="card-head">
        <div class="card-title-wrap">
            ...
            <h2 class="card-title">Şifre sıfırlama</h2>
        </div>
    </div>
    <form method="post" action="<?= htmlspecialchars(AdminAuth::url('/email/templates'), ENT_QUOTES, 'UTF-8') ?>">
        ...
        <div class="form-grid">
            ...
            <div class="field span-2">
                <label class="field-label" for="reset_template_html">HTML şablon (opsiyonel)</label>
