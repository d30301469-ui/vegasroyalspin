...
final class AdminPermissionController extends AdminController
{
    ...
    private function permissionDescription(string $key): string
    {
        return match ($key) {
            ...
            'gsc-plus-settings', 'gsc-plus-products', 'gsc-plus-games', 'gsc-plus-sessions', 'gsc-plus-transactions', 'gsc-plus-wagers', 'gsc-plus-wallet-logs' => 'GSC+ (GamingSoft) seamless wallet, ürün/oyun sync ve launch yönetimi.',
