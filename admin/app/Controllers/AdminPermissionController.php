...
final class AdminPermissionController extends AdminController
{
    ...
    private function permissionDescription(string $key): string
    {
        return match ($key) {
            ...
            'loyalty-levels', 'loyalty-accounts', 'loyalty-transactions', 'loyalty-cashback' => 'Sadakat seviyeleri, üye puanları, puan hareketleri ve cashback ödemelerini yönetme.',
            'deposits', 'withdrawals', 'reports-financial' => 'Yatırım, çekim ve finansal rapor ekranları.',
            'reports-charts', 'reports-calendar', 'reports-geomap', 'backoffice-suite' => 'Dashboard grafikleri, operasyon takvimi ve oyuncu haritası.',
            'risk-analysis' => 'Operasyonel risk analizi ekranı.',
            'affiliates', 'affiliate-reports' => 'Affiliate yönetimi, ödemeler ve raporlar.',
            'gsc-plus-settings', 'gsc-plus-products', 'gsc-plus-games', 'gsc-plus-sessions', 'gsc-plus-transactions', 'gsc-plus-wagers', 'gsc-plus-wallet-logs' => 'GSC+ canlı casino sağlayıcı yönetimi.',
