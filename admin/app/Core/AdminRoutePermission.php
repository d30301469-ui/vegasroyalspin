...
final class AdminRoutePermission
{
    ...
    private static array $staticMap = [
        ...
        '/gsc-plus/sync-products' => 'gamingsoft-settings',
        '/gsc-plus/sync-games' => 'gamingsoft-settings',
        '/gamingsoft/settings' => 'gamingsoft-settings',
        '/gamingsoft/sync-products' => 'gamingsoft-settings',
        '/gamingsoft/sync-games' => 'gamingsoft-settings',
