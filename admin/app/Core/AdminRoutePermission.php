...
final class AdminRoutePermission
{
    ...
    private static array $staticMap = [
        ...
        '/drakon/campaigns' => 'drakon-settings',
        '/drakon/campaigns/create' => 'drakon-settings',
        '/drakon/campaigns/cancel' => 'drakon-settings',
        '/drakon/campaigns/players/add' => 'drakon-settings',
        '/drakon/campaigns/players/remove' => 'drakon-settings',
