...
if (session_status() === PHP_SESSION_NONE) {
    ...
    session_name('FRONTINSTALLSESSID');
...
<meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Kurulum hatası</title></head><body style="font-family:Inter,sans-serif;padding:24px;max-width:720px;margin:0 auto">';
