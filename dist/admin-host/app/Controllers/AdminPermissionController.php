...
final class AdminPermissionController extends AdminController
{
    ...
    private function permissionDescription(string $key): string
    {
        return match ($key) {
            ...
            'drakon-settings', 'drakon-games', 'drakon-providers', 'drakon-transactions', 'drakon-webhook-logs', 'drakon-campaigns' => 'Drakon sağlayıcı ve oyun yönetimi.',
            ...
            'promotions', 'sliders', 'auth-sliders', 'homepage-sections', 'announcements', 'promocodes' => 'Site içerik ve kampanya alanlarını yönetme.',
