            ...
            <div class="casinoGameListBlock games-main" id="gamesScrollContainer">
                ...
                <?php else: ?>
                    <?php foreach ($games as $game): ?>
                        ...
                        $mobileOpenPlayJs = 'var m=(document.body&&document.body.classList.contains(&quot;mobile-site&quot;))||(((navigator.maxTouchPoints||0)&gt;0)&&window.matchMedia&&window.matchMedia(&quot;(max-width: 1024px)&quot;).matches);var u=' . $playHrefJson . ';if(m){try{var p=new URL(u,window.location.origin);p.searchParams.set(&quot;open_mode&quot;,&quot;redirect&quot;);u=p.pathname+p.search+p.hash;}catch(e){u+=(u.indexOf(&quot;?&quot;)===-1?&quot;?&quot;:&quot;&amp;&quot;)+&quot;open_mode=redirect&quot;;}var a=document.createElement(&quot;a&quot;);a.href=u;a.target=&quot;_blank&quot;;a.rel=&quot;noopener noreferrer&quot;;a.style.display=&quot;none&quot;;document.body.appendChild(a);a.click();a.remove();if(document.visibilityState===&quot;hidden&quot;){return;}}window.location.href=u;';
