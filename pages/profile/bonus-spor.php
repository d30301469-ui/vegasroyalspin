    ...
    <main id="profilePlayerMain" name="profilePlayerMain" class="profile-main-content bonus-spor-main">
        <div class="bonus-spor-card">
            <div class="bonus-spor-header">
                ...
                <a href="<?= htmlspecialchars($closeUrl, ENT_QUOTES, 'UTF-8') ?>" class="bonus-spor-close" aria-label="Kapat"<?= $profile_modal ? ' data-profile-modal-close="1"' : '' ?>><i class="fa-solid fa-times"></i></a>
            </div>
