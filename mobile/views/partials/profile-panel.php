...
$panelPartnershipTitle = function_exists('i18n_label')
    ? i18n_label((string) ($panelContactLinks['partnership_title'] ?? 'Ortaklık'), (string) ($panelContactLinks['partnership_url'] ?? ''))
    : (string) ($panelContactLinks['partnership_title'] ?? (function_exists('__') ? __('nav.partnership') : 'Ortaklık'));
...
<aside class="overlay-sliding-wrapper-bc user-profile-container mprofile-panel" id="mprofilePanel" aria-hidden="true" role="dialog" aria-label="<?= htmlspecialchars(__('panel.profile'), ENT_QUOTES, 'UTF-8') ?>" data-site-name="<?= htmlspecialchars($panelSiteName, ENT_QUOTES, 'UTF-8') ?>">
  <div class="overlay-sliding-w-c-content-slider-bc" data-scroll-lock-scrollable>
    <div class="hdr-main-content-bc">
      <div class="logo-container">
        ...
        <a href="<?= htmlspecialchars($panelPartnershipUrl, ENT_QUOTES, 'UTF-8') ?>"<?= $panelPartnershipIsExternal ? ' target="_blank" rel="noopener noreferrer"' : '' ?> class=" header-icon" title="<?= htmlspecialchars($panelPartnershipTitle, ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars($panelPartnershipTitle, ENT_QUOTES, 'UTF-8') ?></a>
      </div>
    ...
    <div class="u-i-p-c-body-bc">
      <div class="u-i-profile-page-bc">
                  ...
                  <div class="u-i-p-amounts-bc withdrawable">
                    <div class="u-i-p-a-content-bc">
                      ...
                      <div class="u-i-p-a-buttons-bc">
                        <a class="u-i-p-a-deposit-bc ellipsis" href="/?profile=open&amp;account=balance&amp;page=deposit"><i class="bc-i-wallet" aria-hidden="true"></i><span class="ellipsis" title="<?= htmlspecialchars(__('profile.deposit'), ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars(__('profile.deposit'), ENT_QUOTES, 'UTF-8') ?></span></a>
                        <a class="u-i-p-a-withdraw-bc ellipsis" href="/?profile=open&amp;account=balance&amp;page=withdraw"><i class="bc-i-withdraw" aria-hidden="true"></i><span class="ellipsis" title="<?= htmlspecialchars(__('profile.withdraw'), ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars(__('profile.withdraw'), ENT_QUOTES, 'UTF-8') ?></span></a>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide swiper-slide-next">
                  <div class="u-i-p-amounts-bc bonuses">
                    <div class="u-i-p-a-content-bc">
                      ...
                      <div class="bonus-info-section"><div><span class="ellipsis"><?= htmlspecialchars(__('profile.total_bonus'), ENT_QUOTES, 'UTF-8') ?></span><b><span data-balance-target="mprofileBonus">...</span> ₺</b></div></div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <a class="u-i-p-a-loyaltyPoint-bc" href="/?profile=open&amp;account=bonuses&amp;page=loyalty-points"><div class="loyaltyBonusHeader"><img class="loyaltyBonusImg" alt="" data-mprofile-loyalty-icon hidden onerror="this.hidden=true"></div><p class="u-i-p-a-loyaltyPointText-bc ellipsis"><?= htmlspecialchars(__('profile.loyalty_points'), ENT_QUOTES, 'UTF-8') ?></p></a>
        <div class="u-i-p-p-u-i-edit-button-bc">
          <p class="u-i-p-p-u-i-avatar-holder-bc" data-mprofile-avatar>...</p>
          <p class="u-i-p-p-u-i-identifiers-bc"><span class="u-i-p-p-u-i-d-username-bc ellipsis" data-mprofile-username><?= htmlspecialchars(__('panel.loading_dots'), ENT_QUOTES, 'UTF-8') ?></span><span class="u-i-p-p-u-i-d-user-id-bc ellipsis" data-mprofile-user-id-wrap hidden><span data-mprofile-user-id></span><i class="u-i-p-p-u-i-d-user-id-copy-bc bc-i-copy" data-user-id="" aria-hidden="true"></i></span></p>
        ...
        <div class="u-i-p-links-lists-holder-bc">
          <div class="u-i-p-l-head-bc" data-href="/profile/details"><i class="user-nav-icon bc-i-user" aria-hidden="true"></i><span class="u-i-p-l-h-title-bc ellipsis"><?= htmlspecialchars(__('profile.section_profile'), ENT_QUOTES, 'UTF-8') ?></span><i class="count-blink-even" data-badge=""></i><i class="u-i-p-l-h-icon-bc bc-i-small-arrow-right" aria-hidden="true"></i></div>
          <div class="u-i-p-l-head-bc" data-href="/profile/deposit"><i class="user-nav-icon bc-i-balance-management" aria-hidden="true"></i><span class="u-i-p-l-h-title-bc ellipsis"><?= htmlspecialchars(__('profile.section_balance'), ENT_QUOTES, 'UTF-8') ?></span><i class="count-blink-even" data-badge=""></i><i class="u-i-p-l-h-icon-bc bc-i-small-arrow-right" aria-hidden="true"></i></div>
          <div class="u-i-p-l-head-bc" data-href="/profile/bet-history"><i class="user-nav-icon bc-i-history" aria-hidden="true"></i><span class="u-i-p-l-h-title-bc ellipsis"><?= htmlspecialchars(__('profile.section_bets'), ENT_QUOTES, 'UTF-8') ?></span><i class="count-blink-even" data-badge=""></i><i class="u-i-p-l-h-icon-bc bc-i-small-arrow-right" aria-hidden="true"></i></div>
          <div class="u-i-p-l-head-bc" data-href="/profile/casino-history"><i class="user-nav-icon bc-i-history" aria-hidden="true"></i><span class="u-i-p-l-h-title-bc ellipsis"><?= htmlspecialchars(__('profile.casino_history'), ENT_QUOTES, 'UTF-8') ?></span><i class="count-blink-even" data-badge=""></i><i class="u-i-p-l-h-icon-bc bc-i-small-arrow-right" aria-hidden="true"></i></div>
          <div class="u-i-p-l-head-bc" data-href="/profile/bonus-spor"><i class="user-nav-icon bc-i-promotion" aria-hidden="true"></i><span class="u-i-p-l-h-title-bc ellipsis"><?= htmlspecialchars(__('profile.section_bonuses'), ENT_QUOTES, 'UTF-8') ?></span><i class="count-blink-even" data-badge=""></i><i class="u-i-p-l-h-icon-bc bc-i-small-arrow-right" aria-hidden="true"></i></div>
          <div class="u-i-p-l-head-bc" data-href="/profile/messages"><i class="user-nav-icon bc-i-message" aria-hidden="true"></i><span class="u-i-p-l-h-title-bc ellipsis"><?= htmlspecialchars(__('profile.section_messages'), ENT_QUOTES, 'UTF-8') ?></span><i class="count-blink-even" data-badge=""></i><i class="u-i-p-l-h-icon-bc bc-i-small-arrow-right" aria-hidden="true"></i></div>
        </div>
        <div class="promoCodeWrapper-bc profile-panel-promo-code" data-mprofile-promo-wrap>
          <form data-mprofile-promo-form onsubmit="return false;">
            <div class="u-i-p-control-item-holder-bc">
              <div class="form-control-bc default">
                <label class="form-control-label-bc inputs">
                  <input type="text" class="form-control-input-bc" name="promoCode" data-mprofile-promo-input step="0" value="" autocomplete="off" maxlength="64">
            ...
            <div class="u-i-p-c-footer-bc">
              <button class="btn a-color big-btn" type="submit" data-mprofile-promo-submit title="<?= htmlspecialchars(__('profile.promo_apply'), ENT_QUOTES, 'UTF-8') ?>" disabled><span><?= htmlspecialchars(__('profile.promo_apply'), ENT_QUOTES, 'UTF-8') ?> </span></button>
            </div>
          </form>
          <div class="mprofile-promo-status" data-mprofile-promo-status role="status" aria-live="polite"></div>
        </div>
        <button class="userLogoutBtn btn" type="button"><i class="userLogoutIcon bc-i-logout" aria-hidden="true"></i><span><?= htmlspecialchars(__('profile.logout'), ENT_QUOTES, 'UTF-8') ?></span></button>
      </div>
      <div class="mprofile-balance-view" data-mprofile-view="balance" aria-hidden="true">
        <div class="back-nav-bc"><i class="back-nav-icon-bc bc-i-round-arrow-left"></i><span class="back-nav-title-bc ellipsis"><?= htmlspecialchars(__('profile.section_balance'), ENT_QUOTES, 'UTF-8') ?></span></div>
        <div class="hdr-navigation-scrollable-bc user-tab-navigation"><div class="hdr-navigation-scrollable-content" data-scroll-lock-scrollable>
          <a class="hdr-navigation-link-bc active" href="/?profile=open&amp;account=balance&amp;page=deposit" data-mbalance-tab="deposit"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.deposit'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=balance&amp;page=withdraw" data-mbalance-tab="withdraw"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.withdraw'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=balance&amp;page=history" data-mbalance-tab="history"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.history'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          ...
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=balance&amp;page=withdraws" data-mbalance-tab="withdraws"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.withdrawal_status'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
        </div></div>
        <div class="dep-w-info-bc deposit-page" data-mbalance-section="deposit" data-scroll-lock-scrollable>
          <div class="horizontalList scroll-start"><div class="horizontal-sl-list-container" data-scroll-lock-scrollable><div class="horizontal-sl-list">
            <div data-id="-1" title="<?= htmlspecialchars(__('winners.all'), ENT_QUOTES, 'UTF-8') ?>" data-badge="" class="horizontal-sl-item-bc accordion-button all active" data-mbalance-category="all"><i class="horizontal-sl-icon-bc bc-i-default-icon bc-i-all"></i><p class="horizontal-sl-title-bc"><?= htmlspecialchars(__('winners.all'), ENT_QUOTES, 'UTF-8') ?></p></div>
            <div data-id="1" title="<?= htmlspecialchars(__('profile.credit_card'), ENT_QUOTES, 'UTF-8') ?>" data-badge="" class="horizontal-sl-item-bc accordion-button bank-card" data-mbalance-category="card"><i class="horizontal-sl-icon-bc bc-i-default-icon bc-i-bank-card"></i><p class="horizontal-sl-title-bc"><?= htmlspecialchars(__('profile.credit_card'), ENT_QUOTES, 'UTF-8') ?></p></div>
          ...
          <div class="m-block-nav-items-bc" id="mprofileDepositMethods"><p class="dw-methods-empty" role="status"><?= htmlspecialchars(__('profile.loading_deposit_methods'), ENT_QUOTES, 'UTF-8') ?></p></div>
        </div>
        <div class="dep-w-info-bc withdraw-page" data-mbalance-section="withdraw" data-scroll-lock-scrollable hidden>
          <div class="horizontalList scroll-start"><div class="horizontal-sl-list-container" data-scroll-lock-scrollable><div class="horizontal-sl-list">
            <div data-id="-1" title="<?= htmlspecialchars(__('winners.all'), ENT_QUOTES, 'UTF-8') ?>" data-badge="" class="horizontal-sl-item-bc accordion-button all active" data-mbalance-withdraw-category="all"><i class="horizontal-sl-icon-bc bc-i-default-icon bc-i-all"></i><p class="horizontal-sl-title-bc"><?= htmlspecialchars(__('winners.all'), ENT_QUOTES, 'UTF-8') ?></p></div>
          ...
          <div class="m-block-nav-items-bc" id="mprofileWithdrawMethods"><p class="dw-methods-empty" role="status"><?= htmlspecialchars(__('profile.loading_withdraw_methods'), ENT_QUOTES, 'UTF-8') ?></p></div>
        </div>
        <div class="dep-w-info-bc mprofile-history-page" data-mbalance-section="history" data-scroll-lock-scrollable hidden>
          <div class="mprofile-history-filters" role="tablist" aria-label="<?= htmlspecialchars(__('profile.history_filters'), ENT_QUOTES, 'UTF-8') ?>"><button class="active" type="button" data-mbalance-history-filter="all"><?= htmlspecialchars(__('winners.all'), ENT_QUOTES, 'UTF-8') ?></button><button type="button" data-mbalance-history-filter="deposit"><?= htmlspecialchars(__('profile.deposit_filter'), ENT_QUOTES, 'UTF-8') ?></button><button type="button" data-mbalance-history-filter="withdraw"><?= htmlspecialchars(__('profile.withdraw'), ENT_QUOTES, 'UTF-8') ?></button></div>
          <div class="mprofile-history-list" id="mprofileTransactionHistory"><p class="dw-methods-empty" role="status"><?= htmlspecialchars(__('profile.loading_history'), ENT_QUOTES, 'UTF-8') ?></p></div>
        </div>
        <div class="description-wrapper-bc" data-mbalance-section="info" data-scroll-lock-scrollable hidden>
          <div class="description-container-bc deposit logged-in">
            <div class="second-tabs-bc"><div class="tab-bc selected-underline active" title="" data-mbalance-info-tab="deposit"><span><?= htmlspecialchars(__('profile.deposit'), ENT_QUOTES, 'UTF-8') ?></span></div><div class="tab-bc selected-underline" title="" data-mbalance-info-tab="withdraw"><span><?= htmlspecialchars(__('profile.withdraw'), ENT_QUOTES, 'UTF-8') ?></span></div></div>
            <div id="mprofileDepositInfo" data-mbalance-info-list="deposit"><p class="dw-methods-empty" role="status"><?= htmlspecialchars(__('profile.loading_deposit_info'), ENT_QUOTES, 'UTF-8') ?></p></div>
            <div id="mprofileWithdrawInfo" data-mbalance-info-list="withdraw" hidden><p class="dw-methods-empty" role="status"><?= htmlspecialchars(__('profile.loading_withdraw_info'), ENT_QUOTES, 'UTF-8') ?></p></div>
          </div>
        </div>
        <div class="dep-w-info-bc mprofile-withdraw-status-page" data-mbalance-section="withdraws" data-scroll-lock-scrollable hidden>
          <div class="mprofile-history-list" id="mprofileWithdrawStatus"><p class="dw-methods-empty" role="status"><?= htmlspecialchars(__('profile.loading_withdraw_status'), ENT_QUOTES, 'UTF-8') ?></p></div>
        </div>
      </div>
      <div class="mprofile-bet-history-view" data-mprofile-view="bet-history" aria-hidden="true">
        <div class="back-nav-bc"><i class="back-nav-icon-bc bc-i-round-arrow-left"></i><span class="back-nav-title-bc ellipsis"><?= htmlspecialchars(__('profile.section_bets'), ENT_QUOTES, 'UTF-8') ?></span></div>
        <div class="hdr-navigation-scrollable-bc user-tab-navigation"><div class="hdr-navigation-scrollable-content" data-scroll-lock-scrollable>
          <a class="hdr-navigation-link-bc active" href="/?profile=open&amp;account=history&amp;page=bets" data-mbet-history-tab="bets"><span class="nav-menu-title"><?= htmlspecialchars(__('winners.all'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=history&amp;page=open-bets" data-mbet-history-tab="open-bets"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.open_bets'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=history&amp;page=cashed-out" data-mbet-history-tab="cashed-out"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.cashed_out'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=history&amp;page=won" data-mbet-history-tab="won"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.won'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          ...
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=history&amp;page=returned" data-mbet-history-tab="returned"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.returned'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=history&amp;page=won-return" data-mbet-history-tab="won-return"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.won_return'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
        ...
        <div class="u-i-e-p-p-content-bc u-i-common-content mprofile-bet-history-content" data-scroll-lock-scrollable>
          <div class="componentFilterWrapper-bc" data-mbet-filter-wrapper>
            <div class="componentFilterLabel-bc active" data-mbet-filter-toggle>
              ...
              <div class="componentFilterLabel-filter-bc"><p class="ellipsis"><?= htmlspecialchars(__('game.filter'), ENT_QUOTES, 'UTF-8') ?></p></div>
            ...
            <div class="componentFilterBody-bc">
              <div class="componentFilterElsWrapper-bc"><form class="filter-form-w-bc">
                <div class="u-i-p-control-item-holder-bc"><div class="form-control-bc default "><label class="form-control-label-bc inputs"><input type="text" inputmode="decimal" class="form-control-input-bc" name="bet_id" step="0" value=""><i class="form-control-input-stroke-bc"></i><span class="form-control-title-bc ellipsis"><?= htmlspecialchars(__('profile.bet_id'), ENT_QUOTES, 'UTF-8') ?></span></label></div></div>
                <div class="u-i-p-control-item-holder-bc"><div class="form-control-bc default "><label class="form-control-label-bc inputs"><input type="text" class="form-control-input-bc" name="name" step="0" value=""><i class="form-control-input-stroke-bc"></i><span class="form-control-title-bc ellipsis"><?= htmlspecialchars(__('profile.sport_name'), ENT_QUOTES, 'UTF-8') ?></span></label></div><i class="sport-search-icon bc-i-search"></i></div>
                <div class="u-i-p-control-item-holder-bc"><div class="form-control-bc select has-icon valid filled"><label class="form-control-label-bc inputs"><select class="form-control-select-bc active" name="bet_type" step="0"><option value=""><?= htmlspecialchars(__('winners.all'), ENT_QUOTES, 'UTF-8') ?></option><option value="1"><?= htmlspecialchars(__('profile.bet_single'), ENT_QUOTES, 'UTF-8') ?></option><option value="2"><?= htmlspecialchars(__('profile.bet_combo'), ENT_QUOTES, 'UTF-8') ?></option><option value="3"><?= htmlspecialchars(__('profile.bet_system'), ENT_QUOTES, 'UTF-8') ?></option><option value="50"><?= htmlspecialchars(__('profile.bet_builder'), ENT_QUOTES, 'UTF-8') ?></option></select><i class="form-control-icon-bc bc-i-small-arrow-down"></i><i class="form-control-input-stroke-bc"></i><span class="form-control-title-bc ellipsis"><?= htmlspecialchars(__('profile.bet_type'), ENT_QUOTES, 'UTF-8') ?></span></label></div></div>
                <div class="u-i-p-control-item-holder-bc"><div class="form-control-bc select has-icon valid filled"><label class="form-control-label-bc inputs"><select class="form-control-select-bc active" name="period" step="0"><option value="24"><?= htmlspecialchars(__('profile.period_24h'), ENT_QUOTES, 'UTF-8') ?></option><option value="72"><?= htmlspecialchars(__('profile.period_72h'), ENT_QUOTES, 'UTF-8') ?></option><option value="168"><?= htmlspecialchars(__('profile.period_week'), ENT_QUOTES, 'UTF-8') ?></option><option value="720"><?= htmlspecialchars(__('profile.period_30d'), ENT_QUOTES, 'UTF-8') ?></option><option value=""><?= htmlspecialchars(__('profile.period_custom'), ENT_QUOTES, 'UTF-8') ?></option></select><i class="form-control-icon-bc bc-i-small-arrow-down"></i><i class="form-control-input-stroke-bc"></i><span class="form-control-title-bc ellipsis"><?= htmlspecialchars(__('profile.period'), ENT_QUOTES, 'UTF-8') ?></span></label></div></div>
                <div class="u-i-p-c-footer-bc"><button class="btn a-color " type="submit" title="<?= htmlspecialchars(__('profile.show'), ENT_QUOTES, 'UTF-8') ?>"><span><?= htmlspecialchars(__('profile.show'), ENT_QUOTES, 'UTF-8') ?></span></button></div>
              </form></div>
            </div>
          </div>
          <div class="mprofile-bet-history-list" id="mprofileBetHistoryList" data-mbet-history-list><p class="empty-b-text-v-bc" role="status"><?= htmlspecialchars(__('profile.section_bets'), ENT_QUOTES, 'UTF-8') ?> <?= htmlspecialchars(__('common.loading_caps'), ENT_QUOTES, 'UTF-8') ?></p></div>
        </div>
      </div>
      <div class="mprofile-casino-history-view" data-mprofile-view="casino-history" aria-hidden="true">
        <div class="back-nav-bc"><i class="back-nav-icon-bc bc-i-round-arrow-left"></i><span class="back-nav-title-bc ellipsis"><?= htmlspecialchars(__('profile.casino_history'), ENT_QUOTES, 'UTF-8') ?></span></div>
        <div class="hdr-navigation-scrollable-bc user-tab-navigation"><div class="hdr-navigation-scrollable-content" data-scroll-lock-scrollable>
          <a class="hdr-navigation-link-bc active" href="/?profile=open&amp;account=bet&amp;page=casino-history" data-mcasino-history-tab="bets"><span class="nav-menu-title"><?= htmlspecialchars(__('winners.all'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=bet&amp;page=casino-history&amp;filter=won" data-mcasino-history-tab="won"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.won'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          ...
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=bet&amp;page=casino-history&amp;filter=returned" data-mcasino-history-tab="returned"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.returned'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
        </div></div>
        <div class="u-i-e-p-p-content-bc u-i-common-content mprofile-bet-history-content mprofile-casino-history-content" data-scroll-lock-scrollable>
          <div class="componentFilterWrapper-bc" data-mcasino-filter-wrapper>
            ...
            <div class="componentFilterBody-bc">
              <div class="componentFilterElsWrapper-bc"><form class="filter-form-w-bc">
                <div class="u-i-p-control-item-holder-bc"><div class="form-control-bc default "><label class="form-control-label-bc inputs"><input type="text" inputmode="decimal" class="form-control-input-bc" name="bet_id" step="0" value=""><i class="form-control-input-stroke-bc"></i><span class="form-control-title-bc ellipsis"><?= htmlspecialchars(__('profile.game_id'), ENT_QUOTES, 'UTF-8') ?></span></label></div></div>
                <div class="u-i-p-control-item-holder-bc"><div class="form-control-bc default "><label class="form-control-label-bc inputs"><input type="text" class="form-control-input-bc" name="name" step="0" value=""><i class="form-control-input-stroke-bc"></i><span class="form-control-title-bc ellipsis"><?= htmlspecialchars(__('profile.game_name'), ENT_QUOTES, 'UTF-8') ?></span></label></div><i class="sport-search-icon bc-i-search"></i></div>
                <div class="u-i-p-control-item-holder-bc"><div class="form-control-bc select has-icon valid filled"><label class="form-control-label-bc inputs"><select class="form-control-select-bc active" name="bet_type" step="0"><option value=""><?= htmlspecialchars(__('winners.all'), ENT_QUOTES, 'UTF-8') ?></option><option value="bet"><?= htmlspecialchars(__('profile.tx_bet'), ENT_QUOTES, 'UTF-8') ?></option><option value="win"><?= htmlspecialchars(__('profile.tx_win'), ENT_QUOTES, 'UTF-8') ?></option><option value="cancel"><?= htmlspecialchars(__('profile.tx_cancel'), ENT_QUOTES, 'UTF-8') ?></option></select><i class="form-control-icon-bc bc-i-small-arrow-down"></i><i class="form-control-input-stroke-bc"></i><span class="form-control-title-bc ellipsis"><?= htmlspecialchars(__('profile.tx_type'), ENT_QUOTES, 'UTF-8') ?></span></label></div></div>
                <div class="u-i-p-control-item-holder-bc"><div class="form-control-bc select has-icon valid filled"><label class="form-control-label-bc inputs"><select class="form-control-select-bc active" name="period" step="0"><option value="24"><?= htmlspecialchars(__('profile.period_24h'), ENT_QUOTES, 'UTF-8') ?></option><option value="72"><?= htmlspecialchars(__('profile.period_72h'), ENT_QUOTES, 'UTF-8') ?></option><option value="168"><?= htmlspecialchars(__('profile.period_week'), ENT_QUOTES, 'UTF-8') ?></option><option value="720"><?= htmlspecialchars(__('profile.period_30d'), ENT_QUOTES, 'UTF-8') ?></option><option value=""><?= htmlspecialchars(__('profile.period_custom'), ENT_QUOTES, 'UTF-8') ?></option></select><i class="form-control-icon-bc bc-i-small-arrow-down"></i><i class="form-control-input-stroke-bc"></i><span class="form-control-title-bc ellipsis"><?= htmlspecialchars(__('profile.period'), ENT_QUOTES, 'UTF-8') ?></span></label></div></div>
                <div class="u-i-p-c-footer-bc"><button class="btn a-color " type="submit" title="<?= htmlspecialchars(__('profile.show'), ENT_QUOTES, 'UTF-8') ?>"><span><?= htmlspecialchars(__('profile.show'), ENT_QUOTES, 'UTF-8') ?></span></button></div>
              </form></div>
            </div>
          </div>
          <div class="mprofile-bet-history-list" id="mprofileCasinoHistoryList" data-mcasino-history-list><p class="empty-b-text-v-bc" role="status"><?= htmlspecialchars(__('profile.casino_history'), ENT_QUOTES, 'UTF-8') ?> <?= htmlspecialchars(__('common.loading_caps'), ENT_QUOTES, 'UTF-8') ?></p></div>
        </div>
      </div>
      <div class="mprofile-bonuses-view" data-mprofile-view="bonuses" aria-hidden="true">
        <div class="back-nav-bc"><i class="back-nav-icon-bc bc-i-round-arrow-left"></i><span class="back-nav-title-bc ellipsis"><?= htmlspecialchars(__('profile.section_bonuses'), ENT_QUOTES, 'UTF-8') ?></span></div>
        <div class="hdr-navigation-scrollable-bc user-tab-navigation"><div class="hdr-navigation-scrollable-content" data-scroll-lock-scrollable>
          <a class="hdr-navigation-link-bc active" href="/?profile=open&amp;account=bonuses&amp;page=bonus-request" data-mbonus-tab="bonus-request"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.bonus_request'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=bonuses&amp;page=sport" data-mbonus-tab="sport"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.bonus_sport'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=bonuses&amp;page=casino" data-mbonus-tab="casino"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.bonus_casino'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=bonuses&amp;page=bonus-history" data-mbonus-tab="bonus-history"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.bonus_history'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=bonuses&amp;page=promo-code" data-mbonus-tab="promo-code"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.promo_code'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=bonuses&amp;page=casino-free-spins" data-mbonus-tab="casino-free-spins"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.freespins'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=bonuses&amp;page=loyalty-points" data-mbonus-tab="loyalty-points"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.loyalty_points'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
        </div></div>
        <div class="mprofile-bonuses-content" data-mbonus-native-content data-scroll-lock-scrollable>
          <div class="mprofile-bonus-request-list" data-mbonus-promotions-list><p class="profile-active-bonus-loading" role="status"><?= htmlspecialchars(__('profile.loading_bonuses'), ENT_QUOTES, 'UTF-8') ?></p></div>
      ...
      <div class="mprofile-messages-view" data-mprofile-view="messages" aria-hidden="true">
        <div class="back-nav-bc"><i class="back-nav-icon-bc bc-i-round-arrow-left"></i><span class="back-nav-title-bc ellipsis"><?= htmlspecialchars(__('profile.section_messages'), ENT_QUOTES, 'UTF-8') ?></span></div>
        <div class="hdr-navigation-scrollable-bc user-tab-navigation"><div class="hdr-navigation-scrollable-content" data-scroll-lock-scrollable>
          <a class="hdr-navigation-link-bc active" href="/?profile=open&amp;account=messages&amp;page=inbox" data-mmessages-tab="inbox"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.inbox'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=messages&amp;page=sent" data-mmessages-tab="sent"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.sent'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=messages&amp;page=new" data-mmessages-tab="new"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.new_message'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
        </div></div>
        <div class="messageBoxWrapper-bc" data-messages-content data-scroll-lock-scrollable>
          <p class="empty-b-text-v-bc" role="status"><?= htmlspecialchars(__('profile.loading_messages'), ENT_QUOTES, 'UTF-8') ?></p>
        </div>
      </div>
      <div class="mprofile-detail-view" data-mprofile-view="details" aria-hidden="true">
        <div class="back-nav-bc"><i class="back-nav-icon-bc bc-i-round-arrow-left"></i><span class="back-nav-title-bc ellipsis"><?= htmlspecialchars(__('profile.section_profile'), ENT_QUOTES, 'UTF-8') ?></span></div>
        <div class="hdr-navigation-scrollable-bc user-tab-navigation"><div class="hdr-navigation-scrollable-content" data-scroll-lock-scrollable>
          <a class="hdr-navigation-link-bc active" href="/?profile=open&amp;account=profile&amp;page=details" data-mprofile-tab="details"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.personal_details'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=profile&amp;page=change-password" data-mprofile-tab="change-password"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.change_password'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
          <a class="hdr-navigation-link-bc" href="/?profile=open&amp;account=profile&amp;page=two-factor-authentication" data-mprofile-tab="two-factor-authentication"><span class="nav-menu-title"><?= htmlspecialchars(__('profile.two_factor'), ENT_QUOTES, 'UTF-8') ?><i class="count-blink-even" data-badge=""></i></span></a>
        ...
        <div class="u-i-e-p-p-content-bc u-i-common-content user-profile mprofile-password-section" data-mprofile-section="change-password" data-scroll-lock-scrollable hidden>
          <div class="profile-security-single profile-security-single--password" id="mprofileChangePassword">
            <form id="mprofileChangePasswordForm" class="password-change-form" onsubmit="return false;">
              ...
              <div class="u-i-p-c-footer-bc password-change-footer"><button class="btn a-color right-aligned" type="submit" id="mprofileChangePwdBtn" title="<?= htmlspecialchars(__('profile.change_password'), ENT_QUOTES, 'UTF-8') ?>"><span><?= htmlspecialchars(__('profile.change_password'), ENT_QUOTES, 'UTF-8') ?></span></button></div>
            </form>
          </div>
        </div>
        ...
        <div class="u-i-e-p-p-content-bc u-i-common-content user-profile mprofile-freeze-section" data-mprofile-section="timeout-limits" data-scroll-lock-scrollable hidden>
          <div class="profile-security-single profile-security-single--freeze" id="mprofileFreezeAccount">
            ...
            <form id="mprofileFreezeForm" class="freeze-form" action="#" autocomplete="off" onsubmit="return false;">
              ...
              <div class="u-i-p-c-footer-bc freeze-footer"><button class="btn a-color right-aligned" type="submit" id="mprofileFreezeSaveBtn" title="<?= htmlspecialchars(__('profile.freeze'), ENT_QUOTES, 'UTF-8') ?>"><span><?= htmlspecialchars(__('profile.freeze'), ENT_QUOTES, 'UTF-8') ?></span></button></div>
            </form>
          </div>
        </div>
      </div>
...
(function () {
  ...
  if (!panel) return;
  try {
    var token = String(localStorage.getItem('app_member_jwt') || '');
    var identity = '';
    if (token) {
...
(function(){
  ...
  function balanceUrl(section,extras){var params=new URLSearchParams();params.set('profile','open');params.set('account','balance');params.set('page',section||'deposit');if(extras&&typeof extras==='object'){Object.keys(extras).forEach(function(key){var value=extras[key];if(value!=null&&value!==''){params.set(key,String(value));}});}return '/?'+params.toString();}
