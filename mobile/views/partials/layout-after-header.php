...
<?php
$mobileRightSheetJsPath = BASE_PATH . '/assets/js/mobile-right-sheet.js';
$mobileRightSheetJsVer = (string) (file_exists($mobileRightSheetJsPath) ? filemtime($mobileRightSheetJsPath) : '1');
?>
...
?>
<script src="<?= htmlspecialchars(asset_url('assets/js/favorites-drawer.js') . '?v=' . rawurlencode($favDrawerVer), ENT_QUOTES, 'UTF-8') ?>"></script>
<script src="<?= htmlspecialchars(asset_url('assets/js/game-favorites.js') . '?v=' . rawurlencode($gameFavVer), ENT_QUOTES, 'UTF-8') ?>"></script>
<?php
$mobileBetslipJsPath = BASE_PATH . '/mobile/assets/js/betslip-mobile.js';
$mobileBetslipJsVer = (string) (file_exists($mobileBetslipJsPath) ? filemtime($mobileBetslipJsPath) : '1');
?>
