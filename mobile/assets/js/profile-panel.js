(function () {
  ...
  function submitPaymentModal() {
    ...
    if (kind === 'deposit') {
      var cryptoType = document.getElementById('mprofilePaymentCryptoType');
      if (cryptoType && cryptoType.value) payload.input_fields = { crypto_type: cryptoType.value };
    }
    if (kind === 'withdraw') {
