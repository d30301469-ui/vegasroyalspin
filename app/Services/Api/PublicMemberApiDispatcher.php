...
final class PublicMemberApiDispatcher
{
    ...
    private const ALLOWED_ROUTES = [
        ...
        'auth/refresh' => true,
        'auth/register' => true,
        'auth/check-availability' => true,
        'auth/reset-password' => true,
        'auth/session' => true,
        'auth/telegram' => true,
        'auth/telegram.php' => true,
        'telegram/status' => true,
        'telegram/status.php' => true,
        ...
        'homepage-sections' => true,
        'homepage-sections.php' => true,
