            ...
            <div class="e-p-content-holder-bc">
                ...
                <form id="modalRegisterForm" novalidate class="entrance-form-bc registration popup register-form-layout<?php echo $registerMobileSingleStep ? ' register-form--mobile-single' : ''; ?>">
                    ...
                    <div class="register-step register-step-1" data-step="1">
                        ...
                        <div class="form-group entrance-f-item-bc">
                            <label class="form-control-label-bc inputs">
                                ...
                                <button type="button" class="toggle-password register-password-toggle" aria-label="Şifreyi göster" aria-pressed="false" data-target-password="#modal_password" style="position:absolute;right:8px;top:50%;transform:translateY(-50%);width:24px;height:24px;min-width:24px;min-height:24px;display:inline-flex;align-items:center;justify-content:center;padding:0;border:0;border-radius:999px;background:rgba(255,255,255,.08);color:rgba(255,255,255,.92);cursor:pointer;z-index:5;">
                                    <span class="register-password-toggle-icon register-password-toggle-icon-show" aria-hidden="true" style="width:14px;height:14px;display:inline-flex;">
                                        <svg viewBox="0 0 24 24" role="presentation" focusable="false" aria-hidden="true" style="width:14px;height:14px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round;">
                                            <path d="M2 12c1.8-4 6.1-7 10-7s8.2 3 10 7c-1.8 4-6.1 7-10 7S3.8 16 2 12Z"></path>
                                            <circle cx="12" cy="12" r="3.2"></circle>
                                        </svg>
                                    </span>
                                    <span class="register-password-toggle-icon register-password-toggle-icon-hide" aria-hidden="true" style="width:14px;height:14px;display:none;">
                                        <svg viewBox="0 0 24 24" role="presentation" focusable="false" aria-hidden="true" style="width:14px;height:14px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round;">
                                            <path d="M2 12c1.8-4 6.1-7 10-7s8.2 3 10 7c-1.8 4-6.1 7-10 7S3.8 16 2 12Z"></path>
                                            <circle cx="12" cy="12" r="3.2"></circle>
                        ...
                        <div class="form-group entrance-f-item-bc">
                            <label class="form-control-label-bc inputs">
                                ...
                                <button type="button" class="toggle-password register-password-toggle" aria-label="Şifreyi göster" aria-pressed="false" data-target-password="#modal_confirm_password" style="position:absolute;right:8px;top:50%;transform:translateY(-50%);width:24px;height:24px;min-width:24px;min-height:24px;display:inline-flex;align-items:center;justify-content:center;padding:0;border:0;border-radius:999px;background:rgba(255,255,255,.08);color:rgba(255,255,255,.92);cursor:pointer;z-index:5;">
                                    <span class="register-password-toggle-icon register-password-toggle-icon-show" aria-hidden="true" style="width:14px;height:14px;display:inline-flex;">
                                        <svg viewBox="0 0 24 24" role="presentation" focusable="false" aria-hidden="true" style="width:14px;height:14px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round;">
                                            <path d="M2 12c1.8-4 6.1-7 10-7s8.2 3 10 7c-1.8 4-6.1 7-10 7S3.8 16 2 12Z"></path>
                                            <circle cx="12" cy="12" r="3.2"></circle>
                        ...
                        <div class="register-turnstile-wrap d-none">
                            <div id="registerTurnstileStep1" class="turnstile-widget" data-turnstile-widget="register"></div>
                        </div>
                    </div>
                    ...
                    <div class="register-step register-step-2<?php echo $registerMobileSingleStep ? '' : ' d-none'; ?>" data-step="2">
                        ...
                        <button type="button" class="register-secondary-btn register-walletconnect-btn register-walletconnect-full btn d-none">
                            <span class="register-walletconnect-icon">
                        ...
                        <button type="button" class="register-secondary-btn register-walletconnect-btn register-walletconnect-full btn">
                            <span class="register-walletconnect-icon">
                                <svg width="141" height="24" viewBox="0 0 178 29" id="w3m-wc-logo-step2" aria-hidden="true">
                                    <path d="M10.683 7.926c5.284-5.17 13.85-5.17 19.134 0l.636.623a.652.652 0 0 1 0 .936l-2.176 2.129a.343.343 0 0 1-.478 0l-.875-.857c-3.686-3.607-9.662-3.607-13.348 0l-.937.918a.343.343 0 0 1-.479 0l-2.175-2.13a.652.652 0 0 1 0-.936l.698-.683Zm23.633 4.403 1.935 1.895a.652.652 0 0 1 0 .936l-8.73 8.543a.687.687 0 0 1-.956 0L20.37 17.64a.172.172 0 0 0-.239 0l-6.195 6.063a.687.687 0 0 1-.957 0l-8.73-8.543a.652.652 0 0 1 0-.936l1.936-1.895a.687.687 0 0 1 .957 0l6.196 6.064a.172.172 0 0 0 .239 0l6.195-6.064a.687.687 0 0 1 .957 0l6.196 6.064a.172.172 0 0 0 .24 0l6.195-6.064a.687.687 0 0 1 .956 0ZM48.093 20.948l2.338-9.355c.139-.515.258-1.07.416-1.942.12.872.258 1.427.357 1.942l2.022 9.355h4.181l3.528-13.874h-3.21l-1.943 8.523a24.825 24.825 0 0 0-.456 2.457c-.158-.931-.317-1.625-.495-2.438l-1.883-8.542h-4.201l-2.042 8.542a41.204 41.204 0 0 0-.475 2.438 41.208 41.208 0 0 0-.476-2.438l-1.903-8.542h-3.349l3.508 13.874h4.083ZM63.33 21.304c1.585 0 2.596-.654 3.11-1.605-.059.297-.078.595-.078.892v.357h2.655V15.22c0-2.735-1.248-4.32-4.3-4.32-2.636 0-4.36 1.466-4.52 3.487h2.914c.1-.891.734-1.426 1.705-1.426.911 0 1.407.515 1.407 1.11 0 .435-.258.693-1.03.792l-1.388.159c-2.061.257-3.825 1.01-3.825 3.19 0 1.982 1.645 3.092 3.35 3.092Zm.891-2.041c-.773 0-1.348-.436-1.348-1.19 0-.733.655-1.09 1.645-1.268l.674-.119c.575-.118.892-.218 1.09-.396v.912c0 1.228-.892 2.06-2.06 2.06ZM70.398 7.074v13.874h2.874V7.074h-2.874ZM74.934 7.074v13.874h2.874V7.074h-2.874ZM84.08 21.304c2.735 0 4.5-1.546 4.697-3.567h-2.893c-.139.892-.892 1.387-1.804 1.387-1.228 0-2.12-.99-2.14-2.358h6.897v-.555c0-3.21-1.764-5.312-4.816-5.312-2.933 0-4.994 2.062-4.994 5.173 0 3.37 2.12 5.232 5.053 5.232Zm-2.16-6.421c.119-1.11.932-1.922 2.081-1.922 1.11 0 1.883.772 1.903 1.922H81.92ZM94.92 21.146c.633 0 1.248-.1 1.525-.179v-2.18c-.218.04-.475.06-.693.06-1.05 0-1.427-.595-1.427-1.566v-3.805h2.338v-2.24h-2.338V7.788H91.47v3.448H89.37v2.24h2.1v4.201c0 2.3 1.15 3.469 3.45 3.469ZM104.62 21.304c [truncated to keep patch readable]
...
/* Cache fallback: register sifre goster/gizle ikonu her durumda gorunsun */
#registerModal .password-input {
    padding-right: 42px !important;
}

#registerModal .register-password-toggle {
...
#registerModal .register-password-toggle-icon {
    width: 14px !important;
    height: 14px !important;
    display: inline-flex !important;
}

#registerModal .register-password-toggle-icon svg {
    width: 14px !important;
    height: 14px !important;
    fill: none !important;
...
#registerModal .register-password-toggle-icon-hide {
    display: none !important;
}

#registerModal .register-password-toggle.is-password-visible .register-password-toggle-icon-show {
    display: none !important;
}

#registerModal .register-password-toggle.is-password-visible .register-password-toggle-icon-hide {
    display: inline-flex !important;
}
</style>
