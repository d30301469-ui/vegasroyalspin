...
$resetPasswordJs = BASE_PATH . '/assets/js/reset-password-screen-v2.js';
...
<script src="/assets/js/reset-password-screen-v2.js?v=<?= urlencode($resetPasswordJsVer) ?>" defer></script>
