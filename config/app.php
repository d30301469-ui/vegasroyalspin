...
if (!function_exists('frontend_open_config_pdo')) {
    /** Returns the shared frontend PDO singleton (App\Core\Database::pdo()). */
...
if (!defined('BACKEND_HOST')) {
    ...
    $backendFallbackHost = parse_url(frontend_env_value(['BACKEND_FALLBACK_URL'], deploy_domain('backend_url')), PHP_URL_HOST);
