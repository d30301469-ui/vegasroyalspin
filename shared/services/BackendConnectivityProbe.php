...
final class BackendConnectivityProbe
{
     ...
     */
    public static function detectInternalConfig(string $backendHost = 'admin.vegasroyalspin.com'): ?array
    {
    ...
    public static function verifyBackendForInstall(string $backendUrl): array
    {
        ...
        require_once shared_package_root() . '/app/Services/InstallEnvBuilder.php';
        ...
        foreach (self::loopbackOrigins() as $loopback) {
            ...
            if ($ping['ok']) {
                return [
                    'ok' => true,
                    'message' => 'Backend ping OK — API henüz hazır olmayabilir. admin.vegasroyalspin.com/install kontrol edin.',
                ];
            }
        }
        ...
        return [
            ...
            'message' => 'Backend erişilemiyor (public: '
                ...
                . '). Önce admin.vegasroyalspin.com/install tamamlayın.',
        ];
    }
     ...
     */
    public static function run(string $publicApiBase, string $backendHost = 'admin.vegasroyalspin.com'): array
    {
        ...
        if (!$out['ok'] && !empty($out['suggested_internal_base']) && empty($out['probes']['internal_env']['ok'])) {
            ...
            $out['hints'] = [
                ...
                'php scripts/bootstrap-frontend-env.php',
                'Once admin.vegasroyalspin.com/install, sonra vegasroyalspin.com/install',
            ];
        }
