...
{
    private const BRONZE_ICON_URL = '/assets/images/loyalty/badges/bronze.svg';
    ...
    public static function ensureStorage(PDO $pdo): void
    {
        ...
        $tables = [
            'loyalty_levels' => "CREATE TABLE IF NOT EXISTS loyalty_levels (
            ...
            'user_loyalty_accounts' => "CREATE TABLE IF NOT EXISTS user_loyalty_accounts (
            ...
            'loyalty_point_transactions' => "CREATE TABLE IF NOT EXISTS loyalty_point_transactions (
                id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
                user_id INT NOT NULL,
                username VARCHAR(120) NULL,
            ...
            'loyalty_cashback_payments' => "CREATE TABLE IF NOT EXISTS loyalty_cashback_payments (
                id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
                user_id INT NOT NULL,
                username VARCHAR(120) NULL,
        ...
        if ($count === 0) {
            ...
            // Keep icon paths on local assets (legacy /content/images paths are missing).
            foreach (self::LOCAL_ICON_URLS as $code => $iconUrl) {
                $pdo->prepare(
                    'UPDATE loyalty_levels SET icon_url = :icon WHERE code = :code'
                )->execute(['icon' => $iconUrl, 'code' => $code]);
            }
        }
    ...
    {
        return [
            ['code' => 'bronze', 'name' => 'Bronze', 'min_points' => 0, 'cashback_rate' => 0.00, 'weekly_bonus_amount' => 0.00, 'icon_url' => self::LOCAL_ICON_URLS['bronze'], 'color_hex' => '#b7791f', 'sort_order' => 10],
            ['code' => 'silver', 'name' => 'Silver', 'min_points' => 1000, 'cashback_rate' => 1.00, 'weekly_bonus_amount' => 100.00, 'icon_url' => self::LOCAL_ICON_URLS['silver'], 'color_hex' => '#94a3b8', 'sort_order' => 20],
            ['code' => 'gold', 'name' => 'Gold', 'min_points' => 5000, 'cashback_rate' => 2.00, 'weekly_bonus_amount' => 250.00, 'icon_url' => self::LOCAL_ICON_URLS['gold'], 'color_hex' => '#f59e0b', 'sort_order' => 30],
            ['code' => 'platinum', 'name' => 'Platinum', 'min_points' => 15000, 'cashback_rate' => 3.00, 'weekly_bonus_amount' => 500.00, 'icon_url' => self::LOCAL_ICON_URLS['platinum'], 'color_hex' => '#60a5fa', 'sort_order' => 40],
            ['code' => 'diamond', 'name' => 'Diamond', 'min_points' => 50000, 'cashback_rate' => 5.00, 'weekly_bonus_amount' => 1000.00, 'icon_url' => self::LOCAL_ICON_URLS['diamond'], 'color_hex' => '#a78bfa', 'sort_order' => 50],
        ];
    }
