...
final class ApiCmsRemote
{
    ...
    {
        // Standalone admin deploy (admin.vegasroyalspin.com): app/Core/AdminDatabase.php
    ...
    public static function pdo(): PDO
    {
        ...
        if (defined('APP_ADMIN_PANEL') && APP_ADMIN_PANEL && class_exists('AdminDatabase', false)) {
     ...
     *
     * Not: API_BACKEND_FALLBACK_BASE_URL sabiti normalize_member_api_public_url()
    ...
    {
        $dir = (defined('BASE_PATH') ? (string) BASE_PATH : shared_package_root()) . '/storage/cache/cms';
        if (!is_dir($dir)) {
            return 0;
        }
        $removed = 0;
